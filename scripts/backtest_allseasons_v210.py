...
from quant_backtest_template_v2_10 import (
    BacktestConfig,
...
OUT = Path("results/allseasons_template_v210")
...
def main() -> None:
    ...
    # Explicit inline fallback dataset required by v2-10: 2001~current cumulative wealth.
    ...
    # Cost sensitivity through the same v2-10 engine.
    sens = []
    ...
    template_path = Path("scripts/quant_backtest_template_v2_10.py")
    meta = {
        ...
        "limitations": [
            ...
            "Because reliable daily commodity history starts in 1991, book_validation and longest MDD/recovery must be monthly_fallback under v2-10.",
