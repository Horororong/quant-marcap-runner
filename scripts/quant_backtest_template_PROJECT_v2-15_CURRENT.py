...
표준 퀀트 백테스트 템플릿 v2-15 / CURRENT (2026-09 KRX PIT 연결)
...
# =========================================================
# 0-A. 한국 개별주 PIT 데이터 계약 / 로더 (v2-15)
# =========================================================
...
36. 사용자가 백테스트를 요청하면 데이터 확인→일별 NAV 생성→CURRENT 표준계산→4기간 성과표→9개 차트 순서를 에이전트가 한 번에 수행한다.
...
def _self_test() -> None:
    ...
    # v2-15: 전체 일별 위험계산은 유지하면서 채팅 Drawdown payload만 제한한다.
